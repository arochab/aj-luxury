...
export default function StaticProductionHero() {
  return (
    <div
      ...
      data-hero-version="openart-dual-v1"
    >
      <div className="aj-film__hero-media">
        <picture className="aj-film__hero-backdrop">
          <source
            media="(max-aspect-ratio: 4 / 5)"
            srcSet="/images/client/aj-luxury-hero-openart-mobile-poster-540.webp 540w, /images/client/aj-luxury-hero-openart-mobile-poster-1080.webp 1080w"
            sizes="100vw"
          />
          <img
            src="/images/client/aj-luxury-hero-openart-desktop-poster.webp"
            alt=""
            width={1920}
            height={1080}
            loading="eager"
