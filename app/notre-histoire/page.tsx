      ...
      <AjScrollReveal className={styles.scene}>
        <section className={styles.hero} aria-labelledby="story-title">
          ...
          <div className={styles.heroBody}>
            <div className={styles.heroCopy} data-aj-reveal>
              <p className={styles.eyebrow}>AJ Luxury</p>
              <h1 id="story-title"><T id="story.title" /></h1>
              <blockquote><T id="story.quote" /></blockquote>
            </div>

            <figure className={styles.heroImage} data-aj-para>
              <Image
                unoptimized
                priority
        ...
        <section className={styles.origin} aria-labelledby="origin-title">
          <div className={styles.actHeading} data-aj-reveal>
            <p className={styles.actIndex}>01</p>
            <h2 id="origin-title"><T id="story.originTitle" /></h2>
          </div>
          <div className={styles.originCopy} data-aj-reveal>
        ...
        <section className={styles.people} aria-labelledby="people-title">
          <div className={styles.peopleHeader}>
            ...
            <p className={styles.peopleStatement} data-aj-reveal>
              <T id="story.peopleStatement" />
            </p>
          </div>

          <div className={styles.portraitGrid}>
            <figure className={styles.portrait} data-aj-reveal>
              <Image
                unoptimized
        ...
        <section className={styles.definition} aria-labelledby="definition-title">
          <div className={styles.definitionCopy}>
            <div className={styles.actHeading} data-aj-reveal>
              ...
              <h2 id="definition-title"><T id="story.definitionTitle" /></h2>
            </div>
            <div className={styles.definitionText} data-aj-reveal>
              <p><T id="story.definitionP1" /></p>
              <p><T id="story.definitionP2" /></p>
            </div>
          </div>
          <figure className={styles.definitionVisual} data-aj-para>
            <Image
              unoptimized
        ...
        <section className={styles.closing} aria-labelledby="closing-title" data-aj-reveal>
          <h2 id="closing-title" lang="en">Reveal Your Inner Beauty</h2>
