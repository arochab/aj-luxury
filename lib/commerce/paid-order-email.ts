...
export function buildPaidOrderEmail(
  ...
  if (kind === "payment-confirmation") {
    return Object.freeze({
      ...
      text: [
        ...
        "Votre facture commerciale numérotée est disponible dans votre espace client : https://ajluxurystore.com/account",
  ...
  return Object.freeze({
    ...
    text: [
      ...
      "Facture commerciale numérotée : https://ajluxurystore.com/account",
      "",
