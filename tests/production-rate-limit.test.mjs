...
test("cart, provider, webhook and operator traffic use separate bindings", async () => {
  ...
  for (const pathname of [
    ...
    "/api/commerce/account/invoices/AJ-AAAAAAAAAAAAAAAAAAAA",
    "/api/commerce/account/credit-notes/AJL-AV-2026-000001",
    "/api/commerce/checkout/payment-session",
    "/api/commerce/webhooks/stripe",
    "/api/commerce/admin/orders/order_1",
    "/api/commerce/admin/orders/order_1/invoice",
    "/api/commerce/admin/orders/order_1/credit-notes/AJL-AV-2026-000001",
    "/api/commerce/admin/orders/order_1/shipping-label",
    "/api/commerce/admin/orders/order_1/customs-document",
    "/api/commerce/admin/shipments/shipment_1/handover",
    "/api/commerce/admin/late-payment-refunds/dispatch",
    "/api/commerce/admin/launch-stock-import",
    "/api/commerce/admin/session",
