...
| AJ-103 | Déduire les réserves du stock physique connu | Décidé, attestation requise | AJ Luxury | 756 initiales ; 749 courantes ; 23 cadeaux restant à réserver ; 726 vendables ; sécurité et SAV à 0 | `docs/internal/STOCK-LAUNCH-RECONCILIATION-2026-08-25.md` | Double attestation du manifeste v2 lié au SHA |
...
| AJ-106 | Gouverner le `.com` canonique et le `.fr` défensif | `.com` terminé ; `.fr` reporté hors lancement | AJ Luxury, conseillé par Adam | `.com` canonique actif ; `.fr` parqué et traité ultérieurement uniquement comme redirection HTTPS vers le `.com` ; aucun site dupliqué | `docs/internal/DNS-CUTOVER-2026-08-08.md`, `docs/internal/DOMAIN-PROTECTION-FR-2026-08-10.md`, facture registrar | Aucun pour le lancement `.com` ; handoff `.fr` séparé ultérieurement |
