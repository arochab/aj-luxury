...
| AJ-111 | Configurer mesure et consentement | À connecter | Adam CHABBI | Trois événements client et `order_paid` serveur séparé, consentement fail-closed, catalogue et origine gouvernés ; fournisseur et activation encore à valider | `docs/ANALYTICS-LOT-2.md` et tests automatisés | AJ-110 |
