...
| AJ-111 | Configurer mesure et consentement | À connecter | Adam CHABBI | Façade client inactive et bundle sans `order_paid` ; entrée serveur non bundleable au navigateur ; 12 variantes `AJ-APO`, snapshot payé et idempotence contractuelle testés ; persistance, fournisseur et activation encore bloqués | `docs/ANALYTICS-LOT-2.md` et tests automatisés | AJ-110 |
